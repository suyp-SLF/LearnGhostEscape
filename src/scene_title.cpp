...
void SceneTitle::init()
{
    ...
    HUDText::addHUDTextChild(this,
                             ...
                             64);
    auto _score_text = "最高分：" + std::to_string(Game::getInstance().getHighScore());
    HUDText::addHUDTextChild(this,
                             _score_text,
                             screen_size / 2.f + glm::vec2(0, 100),
                             glm::vec2(200, 50),
    ...
    _quit_button = HUDButton ::addHUDButtonChild(this,
                                                 glm::vec2(Game::getInstance().getScreenSize().x * 5 / 6, Game::getInstance().getScreenSize().y - 100),
    ...
    _credits_button = HUDButton ::addHUDButtonChild(this,
                                                    glm::vec2(Game::getInstance().getScreenSize().x * 3 / 6, Game::getInstance().getScreenSize().y - 100),
    ...
    _start_button = HUDButton ::addHUDButtonChild(this,
                                                  glm::vec2(Game::getInstance().getScreenSize().x * 1 / 5, Game::getInstance().getScreenSize().y - 100),
